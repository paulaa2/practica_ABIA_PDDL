...
(:init
 ...
 (anterior_dia dia9 dia8)
  ...
  (= (minutos pelicula_0) 144)
  (= (minutos pelicula_1) 27)
  (= (minutos pelicula_2) 119)
  (= (minutos pelicula_3) 130)
  (= (minutos pelicula_4) 175)
  (= (minutos pelicula_5) 20)
  (= (minutos pelicula_6) 134)
  (= (minutos pelicula_7) 88)
  (= (minutos pelicula_8) 78)
  (= (minutos pelicula_9) 171)
...
(predecesor pelicula_0_g0 pelicula_0_g1)
(paralelo pelicula_0_g1 pelicula_0_g2)
(paralelo pelicula_0_g2 pelicula_1_g1)
(predecesor pelicula_0_g2 pelicula_2_g0)
  (visto pelicula_0_g1))
(:goal 
 (and
 (visto pelicula_1_g2)
